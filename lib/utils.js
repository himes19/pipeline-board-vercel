...
function calcScoresFromDeal(deal) {
  ...
  // Etapa del proceso (nuevos stages 1-8)
  let ep = 1;
  const stage = deal.stage || '';
  if (stage.includes('7') || stage.includes('8')) ep = 3;
  else if (stage.includes('3') || stage.includes('4') || stage.includes('5') || stage.includes('6')) ep = 2;
...
const STAGE_STATUS_MAP = {
  ...
  '2 · Propuesta Preliminar':              '6d52c04c-00dc-4078-b363-1c2850c274be',
  '3 · Reunión con Producción':            'f254452a-95e6-4faf-8ec9-b15f7e41c212',
  '4 · Reunión con Calidad':               'd0a1fe0b-01a8-485b-b1cd-d587cead9a9a',
  '5 · Reunión con Finanzas':              '8278d2ee-b2e6-4468-adaf-95a359bafb0c',
  '6 · Reunión Técnica / Pre-Ingeniería':  'c6198929-736c-4307-8571-0b44bbdb8eb2',
  '7 · Desarrollo del Business Case':      '3c6f7342-0206-4280-aa14-2589cd46e20b',
  '8 · Presentación Ejecutiva':            '24abf462-ef5b-4d18-be03-24e433057a18',
